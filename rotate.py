...
xml_dir = root_dir + r"Rotate_Annotations_XML//"  # output xml file path
save = root_dir + r'Rotation_Images//'
...
for img_name in os.listdir(image_dir):
    ...
    r_img = cv2.rotate(img, cv2.cv2.ROTATE_90_CLOCKWISE)  # rotate clock-wise 90-degree
    save_dir = save + r'r_' + img_name
    cv2.imwrite(save_dir, r_img)
